    ...
    <nav class="bg-white">
      <div class="flex items-center font-medium justify-around">
        ...
        <ul class="md:flex hidden uppercase items-center gap-8 font-[Poppins]">
          <li>
            <Link to="/" class="py-4 px-3 pl-3 inline-block">
              Inicio
            </Link>
          </li>
          <NavLinks />
          <li>
            <Link to="/service" class="py-4 px-3 pl-3 inline-block">
              Servicios
            </Link>
          </li>
          <li>
            <Link to="/Dashboard" class="py-4 px-3 pl-3 inline-block">
              Dashboard
            </Link>
          </li>
          <li>
            <Link to="/create/service" class="py-4 px-3 pl-3 inline-block">
              Crear Servicio
            </Link>
          </li>
        </ul>
