...
import { configFilterUserPut, getAllProfesionales } from "../../../redux/actions/users/profesionales";
          ...
          <div className="relative w-full">
            ...
            >
              ...
              {configFilterUser.provincia != false &&
                ...
                provinciasObj[configFilterUser.provincia].map((ciudad, ind) => (
          ...
          <div className="relative w-full">
            ...
            {dias.map((dia) => (
              <div key={dia.id} className="flex items-center">
                ...
                />
                <span className="text-sm">{dia.name}</span>
              </div>
            ))}
          </div>
