            ...
            <section className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 mt-10 gap-8">
              ...
              <div className="bg-blue-600 p-8 rounded-xl text-gray-300 flex flex-col gap-6">
                ...
                <span className="text-5xl text-white">
                  {Math.round(servicesDashboard.serviciosGananciasTodo * 0.15)}
                </span>
                <span className="py-1 px-3 bg-blue-900 rounded-full">
                  {"+ " +
                    Math.round(servicesDashboard.gananciasEsteMes * 0.15) +
                    " este mes"}
                </span>
              </div>
              {/* Card 2 */}
                  ...
                  <div className="flex items-center gap-4 mb-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-500">
                        {servicesDashboard.serviciosEsteMesCount + " este mes"}
                      </p>
                    </div>
                  </div>
                  <div className="flex items-center gap-2 text-gray-500 text-sm">
                    <a
                      className="bg-yellow-100 text-yellow-800 py-1 px-3 rounded-full font-medium"
                      href="dashboard/services/proceso"
                    >
                      Proceso
                    </a>
                    <a
                      className="bg-green-100 text-green-800 py-1 px-3 rounded-full font-medium"
                      href="dashboard/services/terminado"
                    >
                      Finalizado
                    </a>
                  </div>
                  ...
                  <div className="flex items-center gap-4 mb-8">
                    ...
                    <div>
                      <h3 className="font-bold">
                        {servicesDashboard.ultimoUser[0].firstName}
                      </h3>
                      <p className="text-gray-500">
                        {servicesDashboard.ultimoUser[0].role}
                      </p>
                    </div>
                  </div>
                  <div className="flex items-center gap-4 mb-4">
                    {servicesDashboard.ultimoUser[1].imagePerfil ? (
                      <img
                    ...
                    <div>
                      <h3 className="font-bold">
                        {servicesDashboard.ultimoUser[1].firstName}
                      </h3>
                      <p className="text-gray-500">
                        {servicesDashboard.ultimoUser[1].role}
                      </p>
                    </div>
                  </div>
                ...
                <div className="bg-white p-8 rounded-xl shadow-2xl mb-8 flex flex-col gap-8">
                  <div className="grid grid-cols-1 xl:grid-cols-4 items-center gap-4 mb-4">
                    <div className="col-span-2 flex items-center gap-4">
                      {servicesDashboard.ultimosPagos[0]?.imageServiceUrl ===
                      "sin foto" ? (
                        <img
                  ...
                  <div className="grid grid-cols-1 xl:grid-cols-4 items-center gap-4 mb-4">
                    <div className="col-span-2 flex items-center gap-4">
                      {servicesDashboard.ultimosPagos[1]?.imageServiceUrl ===
                      "sin foto" ? (
                        <img
                          src="https://la-oruga.com/wp-content/uploads/2022/04/port.png"
                          className="w-14 h-14 object-cover rounded-xl"
                      ...
                      <div>
                        <h3 className="font-bold">
                          {servicesDashboard.ultimosPagos[1]?.tittle}
                        </h3>
                    ...
                    <div>
                      {servicesDashboard.ultimosPagos[1] ? (
                        <span className="font-bold">
                          {"$ " +
                            servicesDashboard.ultimosPagos[1]?.presupuesto}
                        </span>
                      ) : (
                        <span className="font-bold"></span>
                      )}
                ...
                <div className="bg-white p-8 rounded-xl shadow-2xl mb-8 flex flex-col gap-8">
                  <div className="flex flex-col xl:flex-row xl:items-center justify-between gap-4">
                    <div className="flex items-center gap-4">
                      <img
                        src={
                          servicesDashboard.ultimoService?.userId.imagePerfil
                        }
                        className="w-14 h-14 object-cover rounded-full"
                      />
                      <div>
                        <h3 className="font-bold">
                          {servicesDashboard.ultimoService?.userId.firstName +
                            " " +
                            servicesDashboard.ultimoService?.userId.lastName}
                        </h3>
                        <p className="text-gray-500">{}</p>
                      </div>
                    </div>
