...
,
  ...
  return (
        ...
        <div key={id} class="flex flex-col justify-center items-center h-[100vh]">
            <div class="relative flex flex-col items-center rounded-[20px] w-[700px] max-w-[95%] mx-auto bg-white bg-clip-border shadow-3xl shadow-shadow-500 dark:!bg-navy-800 dark:text-white dark:!shadow-none p-3">
                <div class="mt-2 mb-8 w-full">
                    <h4 class="px-2 text-xl font-bold text-white dark:text-white h-100 overflow-hidden border-solid-gray-300 rounded-lg p-4 bg-blue-500 ">
                    Información General
                    </h4>
                ...
                <div class="grid grid-cols-2 gap-4 px-2 w-full">
                   ...
                   { firstName && lastName ?
                    ...
                    : (<p class="text-base font-medium text-navy-700 dark:text-white">Sin datos</p>)
                     }
                    </div>

                    <div class="flex flex-col justify-center rounded-2xl bg-white bg-clip-border px-3 py-4 shadow-3xl shadow-shadow-500 dark:!bg-navy-700 dark:shadow-none">
                    <p class="text-sm text-gray-600">Lugar de residencia</p>
                    { firstName && lastName ?
                    (<p class="text-base font-medium text-navy-700 dark:text-white">
